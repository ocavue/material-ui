...
If you get this warning from Next.js, please make sure you configure `getInitialProps` in `pages/_document.tsx` correctly. Check the code in this example for more details.
